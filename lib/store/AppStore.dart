...
abstract class AppStoreBase with Store {
  ...
  @observable
  String statusPrivacyValue = '';

  @observable
  List<String> includedSelectedUserList = ObservableList<String>();
  @observable
  List<String> excludedSelectedUserList = ObservableList<String>();

  @observable
  double fontSize = FONT_SIZE_MEDIUM;

  @action
  void setFontSize(double size, int index) {
    fontSize = size;
    fontSizeIndex = index;
  }
  ...
  @action
  void setStatusPrivacyValue(String val) {
    statusPrivacyValue = val;
  }
  ...
  Future<void> setDarkMode(bool aIsDarkMode) async {
    ...
    if (isDarkMode) {
      ...
      setStatusBarColor(Colors.black.withValues(alpha: 0.3),
  ...
  @action
  Future<void> setStatusPrivacy(bool aVal) async {
    isStatusPrivacy = aVal;
  }
}
