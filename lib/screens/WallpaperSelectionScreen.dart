...
class _WallpaperSelectionScreenState extends State<WallpaperSelectionScreen> {
  ...
  init() async {
    ...
    await getWallPaper().then((value) {
      wallpaperList.add(WallpaperModel(name: 'lblBright'.translate, categoryId: 1, isSelected: false, path: brightWallpaper.first.wallpaperPath, sublist: brightWallpaper));
      wallpaperList.add(WallpaperModel(name: 'lblDark'.translate, categoryId: 2, isSelected: false, path: darkWallpaper.first.wallpaperPath, sublist: darkWallpaper));
      wallpaperList.add(WallpaperModel(name: 'lblSolidColors'.translate, categoryId: 3, isSelected: false, path: solidWallpaper.first.wallpaperPath, sublist: solidWallpaper));
    });
  }
