...
class GroupProfileImageDailog extends StatefulWidget {
  ...
  @override
  State<GroupProfileImageDailog> createState() =>
      _GroupProfileImageDailogState();
}
        ...
        children: [
          widget.data!['photourl'] == null || widget.data!['photourl'].isEmpty
              ? Container(
                  ...
                  width: context.width(),
                  color: primaryColor,
                  child: noProfileImageFound(
                      height: 50, width: 50, isNoRadius: true),
              ...
              : InkWell(
                  ...
                  child: Hero(
                    ...
                    child: Image.network(widget.data!['photourl'],
                        fit: BoxFit.cover, height: 350, width: context.width()),
                  ),
                ),
          Container(
            ...
            child: Text(widget.data!['name'],
                style: TS.boldTextStyle(color: Colors.white, size: 20)),
          ),
          Positioned(
            bottom: 0,
            right: 0,
                ...
                children: [
                  IconButton(
                      ...
                      onPressed: () {
                        finish(context);
                        GroupChatScreen(
                                groupChatId: widget.data['id'],
                                groupName: widget.data!['name'],
