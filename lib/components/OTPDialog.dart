...
class OTPDialogState extends State<OTPDialog> {
  ...
  Future<void> sendOTP() async {
    ...
    await authService
        .loginWithOTP(context, number, countryCode ?? "")
        .then((value) {
      //
    }).catchError((e) {
      appStore.setLoading(false);
    ...
    return Observer(
      builder: (_) => !widget.isCodeSent.validate()
          ? Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text("enter_your_phone".translate,
                            maxLines: 2,
                            softWrap: true,
          ...
          : Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                Text("enter_otp_received".translate, style: TS.boldTextStyle()),
                16.height,
                otp.OTPTextField(
