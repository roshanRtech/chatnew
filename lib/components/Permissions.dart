...
class Permissions {
  ...
  static Future<bool> contactPermissionEnabled() async {
  ...
  static Future<PermissionStatus> _getNotificationPermission() async {
    PermissionStatus permission =
        await _handler.checkPermissionStatus(Permission.notification);
    if (permission != PermissionStatus.granted) {
      Map<Permission, PermissionStatus> permissionStatus =
          await _handler.requestPermissions([Permission.notification]);
