    ...
    return Wrap(
      ...
      children: [
        Container(
          ...
          height: 47,
          width:
              isIOS ? (context.width() - 48) / 3 : (context.width() - 40) / 2,
          ...
          child: Row(
            ...
            children: [
              ...
              8.width,
              Text('google'.translate, style: TS.primaryTextStyle()),
            ],
          ),
        ).onTap(
          () async {
            ...
            if (getStringAsync(playerId).isEmpty ||
                getStringAsync(playerId) == null) {
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              8.width,
              Text('mobile'.translate, style: TS.primaryTextStyle()),
            ],
          ),
        ).onTap(() async {
          hideKeyboard(context);
            ...
            child: Row(
              ...
              children: [
                Icon(AntDesign.apple1,
                    color: appStore.isDarkMode ? white : black, size: 20),
                8.width,
                Text('Apple', style: TS.primaryTextStyle()),
              ],
            ),
          ).onTap(() async {
            hideKeyboard(context);
