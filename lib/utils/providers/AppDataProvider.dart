...
List<PopupMenuItem> dashboardPopUpMenuItem = [
  PopupMenuItem(
      value: 1,
      child: Observer(
          builder: (_) => Text('new_chat'.translate,
              style: primaryTextStyle(
                  color: appStore.isDarkMode ? white : black)))),
  PopupMenuItem(
      value: 2,
      child: Observer(
          builder: (_) => Text('new_group'.translate,
              style: primaryTextStyle(
                  color: appStore.isDarkMode ? white : black)))),
  PopupMenuItem(
      value: 3,
      child: Observer(
          builder: (_) => Text('link_device'.translate,
              style: primaryTextStyle(
                  color: appStore.isDarkMode ? white : black)))),
  PopupMenuItem(
      value: 4,
      child: Observer(
          builder: (_) => Text('settings'.translate,
              style: primaryTextStyle(
                  color: appStore.isDarkMode ? white : black)))),
];
...
List<PopupMenuItem> chatScreenPopUpMenuItem = [
  PopupMenuItem(
      value: 1,
      child: Observer(
          builder: (_) => Text('view_Contact'.translate,
              style: primaryTextStyle(
                  color: appStore.isDarkMode ? white : black)))),
  PopupMenuItem(
      value: 2,
      child: Observer(
          builder: (_) => Text('report'.translate,
              style: primaryTextStyle(
                  color: appStore.isDarkMode ? white : black)))),
  PopupMenuItem(
      value: 3,
      child: Observer(
          builder: (_) => Text('block'.translate,
              style: primaryTextStyle(
                  color: appStore.isDarkMode ? white : black)))),
  PopupMenuItem(
      value: 4,
      child: Observer(
          builder: (_) => Text('clear_Chat'.translate,
              style: primaryTextStyle(
                  color: appStore.isDarkMode ? white : black)))),
];
...
List<PopupMenuItem> statusPopUpMenuItem = [
  ...
  PopupMenuItem(
      value: 2,
      child: Observer(
          builder: (_) => Text('status_privacy'.translate,
              style: primaryTextStyle(
                  color: appStore.isDarkMode ? white : black)))),
];
...
List<PopupMenuItem> chatLogPopUpMenuItem = [
  PopupMenuItem(
      value: 1,
      child: Observer(
          builder: (_) => Text('clear_Call_Logs'.translate,
              style: primaryTextStyle(
                  color: appStore.isDarkMode ? white : black)))),
];
