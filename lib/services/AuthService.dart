...
class AuthService {
  ...
  Future<void> updateUserData(UserModel user) async {
    ...
    userService.updateDocument({
      'oneSignalPlayerId': (!getStringAsync(playerId).isEmptyOrNull)
  ...
  Future<void> setUserDetailPreference(UserModel user) async {
    ...
    setValue(isCountryCode, user.countryCode.validate());
  ...
  Future<void> loginFromFirebaseUser(User currentUser,
    ...
    if (await userService.isUserExist(currentUser.email)) {
      ...
      userModel.userStatus = "Hey there, I am using ${AppName}";
      userModel.lastSeen = DateTime.now().millisecondsSinceEpoch;
      userModel.caseSearch =
          setSearchParam((currentUser.displayName) ?? fullName!);
