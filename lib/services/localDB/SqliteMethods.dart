...
class SqliteMethods implements LogInterface {
  ...
  static Future<Database>? initInstance() async {
    ...
    var db = await openDatabase(path, version: 1, onCreate: (Database db, int version) async {
      String createTableQuery = "CREATE TABLE $tableName ($id INTEGER PRIMARY KEY, $callerName TEXT, $callerPic TEXT, $receiverName TEXT, $receiverPic TEXT, "
          "$callStatus TEXT, $timestamp TEXT,$callType TEXT,$callerId TEXT,$receiverId TEXT)";
  ...
  _onCreate(Database db, int version) async {
    String createTableQuery =
        "CREATE TABLE $tableName ($id INTEGER PRIMARY KEY, $callerName TEXT, $callerPic TEXT, $receiverName TEXT, $receiverPic TEXT, $callStatus TEXT, $timestamp TEXT, $callType TEXT,$callerId TEXT,$receiverId TEXT)";
