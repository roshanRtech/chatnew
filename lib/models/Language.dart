...
class Language {
  ...
  static List<Language> getLanguages() {
    return <Language>[
      Language(0, 'français (Default Language)', 'fr', ic_french, 'fr-FR', 'langGroup'),
      Language(1, 'English', 'en', ic_us, 'en-EN', 'langGroup'),
      Language(2, 'ગુજરાતી', 'gu', ic_india, 'gu-IN', 'langGroup'),
      Language(3, 'हिन्दी', 'hi', ic_india, 'hi-IN', 'langGroup'),
      Language(4, 'عربي', 'ar', ic_ar, 'ar-AR', 'langGroup'),
    ];
  }
